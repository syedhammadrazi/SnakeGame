#include "snake.hpp"
#include <iostream>
// Defining all the functions for snake_level_2
void snake_level_2::draw()
{
...
void snake_level_2::snakes_level_2(int x, int y)
{
